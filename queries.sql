...
VALUES ('2021.02.03', 0, 'Собеседование в IT компании','Home.psd', '2021.03.01', 1, 3),
       ...
       ('2021.03.08', 0, 'Встреча с другом','Home.psd', '2021.02.22', 1, 1),
       ('2021.04.10', 0, 'Купить корм для кота','Home.psd', '2021.01.31', 1, 4),
       ('2021.05.02', 0, 'Заказать пиццу','Home.psd', null, 1, 4);
